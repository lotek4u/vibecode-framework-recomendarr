...
| [`architecture/TEST_CASES.md`](architecture/TEST_CASES.md) | Acceptance test suite — user-story-style test cases grouped by feature. The implementation is considered correct when every test case passes. |
